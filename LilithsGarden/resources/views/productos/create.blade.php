...
@section('content')
   <h1>Pagina para crear productos</h1>
   <div class="container">
                ...
                <div class="card-body">
                    <form action="{{route('productos.store')}}" method="POST" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" name="description" class="md-textarea form-control @error('description') is-invalid @enderror" rows="3" required></textarea>
